...
def _main():
    ...
    with substitute_graph.as_default():
        with substitute_sess.as_default():
            ...
            STA = SimulatorTransferAttack(target_model=target_model,
                                          substitute_model=substitute_model,
                                          attacker=attacker
                                          )
            attack_success_rate = STA.transfer_attack(malware_feature_vectors=malware_feature_vectors[:1000],
