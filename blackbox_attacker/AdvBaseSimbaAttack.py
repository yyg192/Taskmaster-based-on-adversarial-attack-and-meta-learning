...
def _main():
    ...
    with target_model_graph.as_default():
        with target_model_sess.as_default():
            ...
            SBA = SimpleBA(target_model, 1, maximum_query_nums)
    ...
    with substitute_graph.as_default():
        with substitute_sess.as_default():
            ...
            print("#################### Adv Base Simba Attack ###################")
            with target_model_graph.as_default():
                with target_model_sess.as_default():
                    SBA.simba_attack(x_adv_all, epsilon=1, target_sess=target_model_sess)
